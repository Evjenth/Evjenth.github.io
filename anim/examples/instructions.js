function piece(evt) {
    ...
    switch (count) {
        case 0:
            furObjects[0].goalPos = [-350/100, 0, -50/100];
            break;
        case 1:
            furObjects[0].goalPos = [-350/100, 0, -500/100];
            furObjects[1].goalPos = [0, 0, -50/100];
            writeText("Place the bottom plate on a clean surface (or a carpet).");
            break;
        case 2:
            furObjects[1].goalPos = [-350/100, 350/100, -480/100];
        ...
        case 3:
            ...
            break;
        case 4:
            furObjects[1].goalPos = [-350/100, 300/100, -480/100];
            writeText("Lower the side plate on to the bottom plate.");
            break;
        case 5:
            furObjects[1].goalPos = [-350/100, 300/100, -500/100];
            furObjects[2].goalPos = [-350/100, 0, 0];
            writeText("Push the plate towards the back, such that the latch screws locks up.");
            break;
        case 6:
            furObjects[2].goalPos = [-50/100, 380/100, -480/100];
        ...
        case 8:
            ...
            break;
        case 9:
            furObjects[2].goalPos = [-50/100, 300/100, -480/100];
            writeText("Lower the side plate on to the bottom plate.");
            break;
        case 10:
            furObjects[2].goalPos = [-50/100, 300/100, -500/100];
            furObjects[3].goalPos = [-675/100, 0, 100/100];
            writeText("Push the plate towards the back, such that the latch screws locks up.");
            break;
        case 11:
            furObjects[3].goalPos = [-335/100, 400/100, -790/100];
        ...
        case 12:
            ...
            break;
        case 13:
            furObjects[3].goalPos = [-335/100, 14/100, -790/100];
            furObjects[4].goalPos = [0, 0, 300/100];
